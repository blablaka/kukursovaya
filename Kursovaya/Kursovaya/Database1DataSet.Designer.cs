...
namespace Kursovaya {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class RegistrationDataTable : global::System.Data.TypedTableBase<RegistrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public RegistrationRow AddRegistrationRow(string Имя, string Фамилия, string Email, string Логин, string Пароль) {
        ...
        public partial class RegistrationRow : global::System.Data.DataRow {
            ...
            public string Имя {
                get {
                    return ((string)(this[this.tableRegistration.ИмяColumn]));
                }
                set {
                    this[this.tableRegistration.ИмяColumn] = value;
                }
            }
            ...
            public string Фамилия {
                get {
                    return ((string)(this[this.tableRegistration.ФамилияColumn]));
                }
                set {
                    this[this.tableRegistration.ФамилияColumn] = value;
                }
            }
            ...
            public string Логин {
                get {
                    return ((string)(this[this.tableRegistration.ЛогинColumn]));
                }
                set {
                    this[this.tableRegistration.ЛогинColumn] = value;
                }
            }
            ...
            public string Пароль {
                get {
                    return ((string)(this[this.tableRegistration.ПарольColumn]));
                }
                set {
                    this[this.tableRegistration.ПарольColumn] = value;
                }
            }
        }
...
namespace Kursovaya.Database1DataSetTableAdapters {
    ...
    public partial class RegistrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Registration] WHERE (([Id] = @Original_Id) AND ([Имя] = @Origi" +
                "nal_Имя) AND ([Фамилия] = @Original_Фамилия) AND ([Email] = @Original_Email) AND" +
                " ([Логин] = @Original_Логин) AND ([Пароль] = @Original_Пароль))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Registration] ([Имя], [Фамилия], [Email], [Логин], [Пароль]) V" +
                "ALUES (@Имя, @Фамилия, @Email, @Логин, @Пароль);\r\nSELECT Id, Имя, Фамилия, Email" +
                ", Логин, Пароль FROM Registration WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Registration] SET [Имя] = @Имя, [Фамилия] = @Фамилия, [Email] = @Email, [Логин] = @Логин, [Пароль] = @Пароль WHERE (([Id] = @Original_Id) AND ([Имя] = @Original_Имя) AND ([Фамилия] = @Original_Фамилия) AND ([Email] = @Original_Email) AND ([Логин] = @Original_Логин) AND ([Пароль] = @Original_Пароль));
SELECT Id, Имя, Фамилия, Email, Логин, Пароль FROM Registration WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Kursovaya.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Имя, Фамилия, Email, Логин, Пароль FROM dbo.Registration";
        ...
        public virtual int Delete(int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Email, string Original_Логин, string Original_Пароль) {
        ...
        public virtual int Insert(string Имя, string Фамилия, string Email, string Логин, string Пароль) {
            if ((Имя == null)) {
        ...
        public virtual int Update(string Имя, string Фамилия, string Email, string Логин, string Пароль, int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Email, string Original_Логин, string Original_Пароль, int Id) {
            if ((Имя == null)) {
                throw new global::System.ArgumentNullException("Имя");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Фамилия, string Email, string Логин, string Пароль, int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Email, string Original_Логин, string Original_Пароль) {
            return this.Update(Имя, Фамилия, Email, Логин, Пароль, Original_Id, Original_Имя, Original_Фамилия, Original_Email, Original_Логин, Original_Пароль, Original_Id);
        }
    }
